			...
			<div class="row">
				<div class="col s12">
					<ul class="modelos_autos">
						<li>No gracias, ver Resumen de Reserva y proceder a <a href="" target="_self">Arrendar</a></li>
					</ul>			
				</div><!-- /.col -->
				...
				<div class="col l8 s12">
						...
						<div class="box_car">
							<div class="row">
								<div class="col m12 s12">
									<div class="box_info">
										<h5>Radio Satelital</h5>
									  <p>$10.990 por día, total por 5 días $54.950</p>
									  <a href="" target="" class="btn_orange">Agregar</a>
									</div>
								</div><!-- /.col -->
							</div><!-- /.row -->
						</div><!-- /.box_car -->
						...
						<div class="box_car">
							<div class="row">
								<div class="col m12 s12">
									<div class="box_info">
										<h5>GPS</h5>
									  <p>$5.990 por día, total por 5 días $25.950</p>
									  <a href="" target="" class="btn_orange">Agregar</a>
									</div>
								</div><!-- /.col -->
							</div><!-- /.row -->
					...
					<div class="row">
						...
						<div class="col s6">
							<a href="" target="" class="btn_white right">Omitir</a>
							<a href="" target="" class="btn_white right" style="margin-right: 10px;">Volver</a>
						</div>
					</div><!-- /.row -->
				</div><!-- /.col l8-->
						...
						<div class="item center">
						  ...
						  <p class="grey-text">$22.990 por día, total por 5 días $114.950</p>
							...
							<div class="dato_reserva">
								<p><a href="" target="" class="btn_editar"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>editar</a></p>
							</div><!-- /.datos_reserva -->
						</div>
