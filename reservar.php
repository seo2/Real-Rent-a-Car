		  ...
		  <nav class="" role="navigation">
		    <div class="nav-wrapper container"><a href="index.html" target="_self" class="brand-logo"><img src="assets/img/real_rent_a_car.svg" width="150"/></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="reservar.html" target="_self" class="selected">Reservar</a></li>
			...
			<div class="row">
				<div class="col s12">
					<ul class="modelos_autos">
						<li><a href="" target="" class="selected">Todos</a></li>
						<li>/</li>
						<li><a href="" target="" class="">SUV</a></li>
						<li>/</li>
						<li><a href="" target="" class="">Sedán</a></li>
						<li>/</li>
						<li><a href="" target="" class="">City Car</a></li>
						<li>/</li>
						<li><a href="" target="" class="">Furgón</a></li>
						<li>/</li>
						<li><a href="" target="" class="">Camioneta</a></li>
					</ul>			
				</div><!-- /.col -->
				...
				<div class="col l8 s12">
					...
					<div class="box_cars">
							...
							<div class="row">
								...
								<div class="col m8 s12">
									<div class="box_info">
									  ...
									  <p class="grey-text">$22.990 por día, total por 5 días $114.950</p>
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/fiat_punto.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Fiat</h5>
									  <p>Grande Punto 1.2</p>
									  <div class="features_car">
										  <i class="fa fa-users" aria-hidden="true"></i> 4 /
										  <i class="fa fa-suitcase" aria-hidden="true"></i> 4 /
										  <i class="fa fa-sitemap" aria-hidden="true"></i> M
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/mercedez_a200.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Mercedes Benz</h5>
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/kia_sorento.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Kia</h5>
									  <p>Sorento Ex 2.2L DSL</p>
									  <div class="features_car">
										  <i class="fa fa-users" aria-hidden="true"></i> 4 /
										  <i class="fa fa-suitcase" aria-hidden="true"></i> 4 /
										  <i class="fa fa-sitemap" aria-hidden="true"></i> A
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/volkswagen_voyage_power_16.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Volkswagen</h5>
									  <p>Voyage Power 1.6</p>
									  <div class="features_car">
										  <i class="fa fa-users" aria-hidden="true"></i> 4 /
										  <i class="fa fa-suitcase" aria-hidden="true"></i> 4 /
										  <i class="fa fa-sitemap" aria-hidden="true"></i> A
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/volkswagen_transporter.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Volkswagen</h5>
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/hyundai_santafe.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Hyundai</h5>
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/nissan_march.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Nissan</h5>
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/volkswagen_voyage.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Volkswagen</h5>
						...
						<div class="box_car">
							<div class="row">
								<div class="col m4 s12 center">
									<img src="assets/img/autos/volkswagen_amarok.jpg" width="210"/>
								</div><!-- /.col -->
								<div class="col m8 s12">
									<div class="box_info">
										<h5>Volkswagen</h5>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col l6 s12 content">
						...
						+56 2 9000 4000<br><br>
						
						<span>Atención Electrónica 24/7</span><br>
						contacto@realrentacar.cl<br><br>
						
						Infante 22, Providencia,<br> 
						Santiago, RM<br>
						CHILE
						</p>
					</div><!-- /.col -->
